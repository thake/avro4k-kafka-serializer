...
class KafkaAvro4kDeserializerConfig(props: Map<String, *>) : AbstractKafkaAvro4kSerDeConfig(baseConfigDef(), props) {
    ...
    companion object {
        ...
        fun baseConfigDef() = AbstractKafkaAvro4kSerDeConfig.baseConfigDef().define(
            RECORD_PACKAGES,
